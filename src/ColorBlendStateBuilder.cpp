#include "vulkanizer/ColorBlendStateBuilder.hpp"

namespace vkz {

    ColorBlendStateBuilder::ColorBlendStateBuilder(Device device, GraphicsPipelineBuilder *parent)
    ...
    VkPipelineColorBlendStateCreateInfo &ColorBlendStateBuilder::buildColorBlendState() {
        ...
        _info.attachmentCount = VKZ_COUNT(colorAttachmentStates);
    ...
    ColorBlendAttachmentStateBuilder::buildColorBlendAttachmentState() {
        return _states;
    }
