#include "vulkanizer/ViewportStateBuilder.hpp"

namespace vkz {

    ViewportStateBuilder::ViewportStateBuilder(Device device, GraphicsPipelineBuilder *parent)
            : GraphicsPipelineBuilder(device, parent), _viewportBuilder{new ViewportBuilder{this}},
