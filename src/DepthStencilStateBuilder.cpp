#include "vulkanizer/DepthStencilStateBuilder.hpp"

namespace vkz {

    DepthStencilStateBuilder::DepthStencilStateBuilder(Device device, GraphicsPipelineBuilder *parent)
    ...
    StencilOpStateBuilder::StencilOpStateBuilder(DepthStencilStateBuilder *parent)
            : DepthStencilStateBuilder(parent), _stencilOpState{} {
    }
